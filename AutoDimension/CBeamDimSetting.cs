...
namespace AutoDimension
{
    ...
    /// 梁标注顶视图配置;
    /// </summary>
    public class CBeamTopViewSetting
    {
    ...
    /// 梁标注前视图配置;
    /// </summary>
    public class CBeamFrontViewSetting
    {
        public const string mstrWorkPointToMainPart = "工作点与主零件距离";
        public const string mstrSupportPlate = "支撑及牛腿";
        public const string mstrVerticalConnectPlate = "垂直连接及加筋板";
        ...
        public const string mstrMainPartLength = "主部件长度";
        public const string mstrAngleSheet = "角钢";
        public const string mstrMainBeamMiddlePart = "腹板上水平部件";
        public const string mstrBolt = "主部件螺栓";
        public const string mstrWorkPointToWorkPoint = "工作点到工作点";
        public const string mstrCutting = "切割";
    ...
    /// 梁标注剖视图设置;
    /// </summary>
    public class CBeamSectionViewSetting
    {
        /// <summary>
        /// 标注对象字符串与标注设置的映射表;
        /// </summary>
        ...
        /// 剖视图标注设置;
        /// </summary>
        public CBeamSectionViewSetting()
        {
    ...
    /// 梁标注配置;
    /// </summary>
    public class CBeamDimSetting
    {
        /// <summary>
        /// 单例;
        /// </summary>
        private static CBeamDimSetting mInstance = null;

        /// <summary>
        /// 顶视图标注设置;
        /// </summary>
        public CBeamTopViewSetting mTopViewSetting = null;

        /// <summary>
        /// 前视图标注设置;
        /// </summary>
        public CBeamFrontViewSetting mFrontViewSetting = null;

        /// <summary>
        /// 剖视图标注设置;
        /// </summary>
        public CBeamSectionViewSetting mSectionViewSetting = null;
        ...
        /// </summary>
        /// <returns></returns>
        public static CBeamDimSetting GetInstance()
        {
            if (null == mInstance)
            {
                mInstance = new CBeamDimSetting();
            }
